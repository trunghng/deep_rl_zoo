...
# final
# python3 ppo.py --env HalfCheetah-v2 --cpu 4 --hidden-layers 64 32 --pi-lr 3e-4 --v-lr 1e-3 --epochs 750\
# 	--steps-per-epoch 4000 --train-pi-iters 80 --train-v-iters 80 --max-ep-len 1000\
# 	--gamma 0.99 --lamb 0.97 --clip --clip-ratio 0.2 --kl-target 0.01 --seed 10 --save --render
