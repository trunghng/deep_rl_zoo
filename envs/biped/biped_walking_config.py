...
class BipedWalkingConfig(BipedConfig):
    ...
    class rewards(BipedConfig.rewards):
        class scales:
            ...
            lin_vel_y = -2.0           # Penalty for drifting sideways
            ang_vel_z = -2.0           # Penalty for twisting the torso (yaw)
            ...
            swing = 0.5                # Bonus for lifting a foot high into the air
            ...
            lin_vel_z = -0.1           # Penalty for bouncing/jumping too much vertically
