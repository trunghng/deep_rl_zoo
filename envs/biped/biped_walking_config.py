...
class BipedWalkingConfig(BipedConfig):
    ...
    class rewards(BipedConfig.rewards):
        class scales:
            progress = 2.0             # Reward for absolute distance traveled along X-axis
            ...
            # Stability and Form
            upright = 1.5              # Bonus for keeping the torso perfectly vertical
            air_time = 5.0             # Bonus for a beautiful walking gait (0.5s steps)
            ...
            stumble = -0.01            # Penalty if the foot hits a vertical obstacle (like the lip of a stair)
            bounce = -0.5              # Penalty for bouncing/jumping too much vertically
